...
async function test () {
    ...
    const pPoolCreator = ctcPC.p.PoolCreator({
        getPoolDetails: {
            poolName: "Umunna Collection",
            poolDescription: "An Arbitrary sized club. Where anyone can join, make a payment as specified an request for a pay after each cycle. This description is going to be 200 bytes long so I'm going to keep typing till",
  ...
  render() {
    return (<div align="center">
      <PipelineShell width="600px">
        <Heading>Reach + PIPELINE-UI + ALGORAND </Heading>
